...
.. figure:: /Media/Monitors/PIM-101-C/pim-101-front.jpeg
   :figclass: align-center
   :class: no-scaled-link

   Front View (Panel Mounting Variant)

.. figure:: /Media/Monitors/PIM-101-C/pim-101-back.jpeg
   :figclass: align-center
   :class: no-scaled-link

   Back View (Panel Mounting Variant)

.. figure:: /Media/Monitors/PIM-101-C/pim-101-bottom.jpeg
   :figclass: align-center
   :class: no-scaled-link

   Bottom View (Embedded Variant)
