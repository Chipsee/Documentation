.. |product| replace:: EPC/PPC-A8-50-C

.. |productE| replace:: EPC-A8-50-C

.. |productP| replace:: PPC-A8-50-C
...
.. |disp_des| replace:: |dispsize| ten-point capacitive and resistive touch screen with a resolution of |res| pixels
...
.. figure:: /Media/ARM/A8/CS80480T050/PPC-A8-50-C-Front.jpeg
   :figclass: align-center
   :class: no-scaled-link

   Front View (Panel Mounting Variant)

.. figure:: /Media/ARM/A8/CS80480T050/PPC-A8-50-C-Back.jpeg
   :figclass: align-center
   :class: no-scaled-link

   Back View (Panel Mounting Variant)

.. figure:: /Media/ARM/A8/CS80480T050/EPC-A8-50-C-Front.jpeg
   :figclass: align-center
   :class: no-scaled-link

   Front View (Embedded Variant)

.. figure:: /Media/ARM/A8/CS80480T050/EPC-A8-50-C-Back.jpeg
   :figclass: align-center
   :class: no-scaled-link
...
The serial communication interfaces (RS485, RS482, and CAN) are routed to a **12-pin 3.81mm terminal**, as illustrated on *Figure 3*.

.. figure:: /Media/ARM/A8/AM3354/IO-Peripherals.jpeg
   :align: center
   :figclass: align-center

   *Figure 3: Relation between serial pins on embedded vs. enclosed version of the* |product| *Industrial PC*

The table below offers more detailed description of every pin and its definition:

.. table:: Table 3: Connectivity Section
   :align: center
   :width: 100%
...
On the embedded panel PC version, the pink connector is the audio input jack (line-in) and the blue connector is the audio output jack (line-out, typically around -10 dBV). On the enclosed panel PC version, both audio input and audio output are clearly marked (*Figure 8)*

.. figure:: /Media/ARM/A8/AM3354/Audio.jpeg
  :figclass: align-center
  :align: center

  *Figure 8: Audio I/O (embedded/enclosed PC version)*
...
The outer mechanical dimensions of |productE| are |dimE| (W x L x H) and |productP| are |dimP| (W x L x H). Please refer to the technical drawing in *Figure 10a* for details related to the specific
product measurements.

.. figure:: /Media/ARM/A8/CS80480T050/EPC-A8-50-C-TD.jpeg
   :align: center
   :figclass: align-center

   *Figure 10:* |productE| *Technical Drawing*

|productP|
----------
For |productP|, the outer mechanical dimensions are |dimP| (W x L x H). Please refer to the technical drawing in *Figure 10b* for details related to the specific
product measurements.
