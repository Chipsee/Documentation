...
There are 2 x dual Type A **USB HOST connectors** onboard, as shown in the figure below.
...
The pink connector is the audio input jack (line-in) and the blue connector is the audio output jack (line-out, typically around -10 dBV) as shown in the figure below.
