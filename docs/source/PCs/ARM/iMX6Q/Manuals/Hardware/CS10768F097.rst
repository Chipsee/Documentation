...
.. Add the `product-img` word to the image class directive in order for the thumbnail feature to work

.. image:: /Media/ARM/A9/CS10768F097/PPC-A9-97-C-Front.jpg
   :class: no-scaled-link product-img
   :alt: Front View (Panel Mounting Variant)

.. image:: /Media/ARM/A9/CS10768F097/PPC-A9-97-C-Back.jpg
   :class: no-scaled-link product-img
   :alt: Back View (Panel Mounting Variant)

.. image:: /Media/ARM/A9/CS10768F097/EPC-A9-97-C-Front.jpg
   :class: no-scaled-link product-img
   :alt: Front View (Embedded Variant)

.. image:: /Media/ARM/A9/CS10768F097/EPC-A9-97-C-Back.jpg
   :class: no-scaled-link product-img
