...
.. figure:: /Media/ARM/A72/CS10768R150/PPC-A72-150-C-Front.jpeg
   :figclass: align-center
   :class: no-scaled-link

   Front View

.. figure:: /Media/ARM/A72/CS10768R150/PPC-A72-150-C-Back.jpeg
   :figclass: align-center
   :class: no-scaled-link
...
|Product| has 1 x DB9 connector that is configured for debugging by default as shown in the figure below.
